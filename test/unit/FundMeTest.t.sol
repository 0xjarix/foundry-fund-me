...
contract FundMeTest is Test {
    ...
    function testithdrawWithASingleFunder() public funded {
        //Arrange
    ...
    function testWithdrawFromMultipleFunders() public funded {
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            //vm.prank to create a new address
            //vm.deal to fund this new created address
            //hoax can replace them by creating a new address that is funded
